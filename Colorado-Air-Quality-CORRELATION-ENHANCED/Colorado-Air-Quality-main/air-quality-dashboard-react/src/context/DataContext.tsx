  ...
  const fetchTrendData = async () => {
    try {
      ...
      const asthmaEmergencyData = data
        .filter(d => d.emergencyVisitRate !== null)
        .map(d => ({ date: d.date, value: d.emergencyVisitRate }));
      ...
      const mockAlertDays = fallbackData.map(day => ({
        ...
        alertLevel: day.value > 35 && day.emergencyVisitRate > 10 ? 'high' : 
                   day.value > 25 || day.emergencyVisitRate > 8 ? 'moderate' : 'low'
      }));

                ...
                <div className="card">
                  ...
                  <ul className="space-y-4">
                    <li className="flex">
                      ...
                      <span>ZIP codes with PM2.5 levels above 35 μg/m³ show 23% higher asthma rates on average.</span>
                    </li>
                    <li className="flex">
                      <svg className="w-6 h-6 text-primary-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span>Seasonal variations show stronger correlations during summer months when ozone levels peak.</span>
                    </li>
                    <li className="flex">
                      <svg className="w-6 h-6 text-primary-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span>Urban areas show a 15% higher correlation between air quality and asthma rates compared to rural areas.</span>
                    </li>
                    <li className="flex">
                      <svg className="w-6 h-6 text-primary-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span>For every 10 μg/m³ increase in PM2.5, asthma-related hospital visits increase by approximately 8%.</span>
                    </li>
                  </ul>
                </div>
              </div>

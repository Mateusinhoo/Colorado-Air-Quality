...
interface HeaderProps {
  ...
  toggleDarkMode: () => void;
  activeTab: string;
  setActiveTab: (tab: string) => void; // Changed from React.Dispatch<React.SetStateAction<string>> to accept any function that takes a string
}
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-1">
          ...
          <button 
            ...
            className={`nav-link ${activeTab === 'books' ? 'nav-link-active' : 'hover:bg-gray-100 dark:hover:bg-gray-800'}`}
          >
            <span className="flex items-center">
              <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

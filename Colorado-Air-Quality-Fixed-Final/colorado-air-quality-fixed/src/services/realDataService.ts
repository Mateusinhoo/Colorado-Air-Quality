...
class RealDataService {
  ...
  async getCountyAsthmaData(): Promise<Array<{county: string, asthmaRate: number, emergencyVisits: number}>> {
    ...
    return [
      { county: 'Denver', asthmaRate: 89.2, emergencyVisits: 156 },
      { county: 'Jefferson', asthmaRate: 76.8, emergencyVisits: 134 },
      { county: 'Arapahoe', asthmaRate: 82.1, emergencyVisits: 143 },
      { county: 'Boulder', asthmaRate: 71.3, emergencyVisits: 125 },
      { county: 'El Paso', asthmaRate: 94.7, emergencyVisits: 165 },
      { county: 'Larimer', asthmaRate: 68.9, emergencyVisits: 120 },
      { county: 'Adams', asthmaRate: 91.5, emergencyVisits: 159 },
      { county: 'Douglas', asthmaRate: 65.2, emergencyVisits: 114 }
    ];
  }
